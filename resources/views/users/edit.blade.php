...
<div class="page-header">
    <h3 class="page-title">تعديل المستخدم والصلاحيات</h3>
</div>
    ...
    <form action="{{ route('users.update', $user->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control frst" autofocus required value="{{ old('name', $user->name) }}">
        ...
        <div class="mb-4">
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" id="roleAdmin" name="roles[]" value="admin" {{ $isAdmin ? 'checked' : '' }}>
    ...
    $(document).ready(function() {
        $('#roleAdmin').change(function() {
            if($(this).is(':checked')) {
                ...
                $('#permissionsContainer input').prop('checked', true).prop('disabled', true);
            } else {
                $('#permissionsContainer').css('opacity', '1');
                $('#permissionsContainer input').prop('checked', false).prop('disabled', false);
            }
        });
