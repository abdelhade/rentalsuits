...
<div class="page-header">
    <h3 class="page-title">تعديل بيانات العميل</h3>
</div>
    ...
    <form action="{{ route('customers.update', $customer->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control frst" autofocus required value="{{ old('name', $customer->name) }}">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="phone_2" id="phone_2" class="form-control" value="{{ old('phone_2', $customer->phone_2) }}">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="national_id" id="national_id" class="form-control" value="{{ old('national_id', $customer->national_id) }}" required>
            ...
            <div class="col-md-12 mb-3">
                ...
                <select name="referred_by" id="referred_by" class="form-select select2">
                    ...
                    @foreach($customers as $c)
                        <option value="{{ $c->id }}" {{ old('referred_by', $customer->referred_by) == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                    @endforeach
                </select>
